...
export async function GET(req: NextRequest) {
  ...
  const qrDataUrl = qrSvg ? `data:image/svg+xml;base64,${Buffer.from(qrSvg).toString("base64")}` : "";
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
              <span style={{ fontSize: 10, color: "rgba(255,255,255,0.2)", letterSpacing: 3, textTransform: "uppercase" }}>
                Miembro
              </span>
          ...
          >
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 20 }}>
                {member.company && (
                  <div style={{ display: "flex", flexDirection: "column", minWidth: 140 }}>
                    <span style={{ fontSize: 9, color: "rgba(255,255,255,0.2)", letterSpacing: 2, textTransform: "uppercase" }}>
                      Empresa
                    </span>
            ...
            {qrDataUrl && (
              ...
              >
                ...
                <span style={{ fontSize: 8, color: "rgba(255,255,255,0.15)", letterSpacing: 3, marginTop: 8, textTransform: "uppercase" }}>
