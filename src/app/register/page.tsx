      ...
      <div className="w-full max-w-xl">
        ...
        <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 sm:p-8">
          ...
          <div className="mt-6 border-t border-white/5 pt-6">
            <p className="mb-4 text-center font-mono text-xs text-white/20">
              O registrate directamente con
            </p>
            <button
              onClick={async () => {
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3.5 font-mono text-sm text-white transition-all hover:border-white/20 hover:bg-white/[0.06]"
            >
