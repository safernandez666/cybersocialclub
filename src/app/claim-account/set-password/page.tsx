    ...
    <Suspense
      fallback={
        <div className="flex min-h-screen items-center justify-center bg-[#0A0A0A]">
          <span className="font-mono text-xs text-white/30">Cargando...</span>
        </div>
      }
    >
      <SetPasswordContent />
...
function SetPasswordContent() {
  ...
  // Read token from hash and clear it immediately
  useEffect(() => {
    ...
    if (hash) {
      ...
      // Clear hash from URL bar without reloading
      ...
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0A0A0A] px-4 pt-16">
        ...
        >
          ...
          <p className="mb-6 font-mono text-xs text-white/30">
            El link no contiene un token válido. Solicitá uno nuevo.
          </p>
          <Link
            href="/claim-account"
          ...
          {!success ? (
            ...
            >
              <div className="mb-8">
                <Link
                  href="/login"
                  className="mb-6 inline-flex items-center gap-2 text-white/30 transition-colors hover:text-white"
                >
                ...
                <p className="font-mono text-xs text-white/30">
                  Completá los datos para activar tu cuenta.
                </p>
              </div>
            ...
            >
              ...
              <h2 className="mb-2 font-mono text-xl text-white">
                ¡Cuenta activada!
              </h2>
